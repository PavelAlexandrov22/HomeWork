...
//        Assertions.assertArrayEquals(arr, fromContainer);
    ...
    public void sort1(){
        ...
        container.sort(new Comparator<String>() {
            @Override
        ...
        //лямда
        container.sort(((o1, o2) -> Integer.compare(o1.length(), o2.length())));
    ...
    public void sortWithNull(){
        Integer[] arr = new Integer[]{3, 1, null, 3, 777};
        DataContainer<Integer> container = new DataContainer<>(arr);
        ...
        Assertions.assertEquals(777, container.get(4));
    }
}
